...
class DistributorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create distributor" do
    assert_difference('Distributor.count') do
      post distributors_url, params: { distributor: { age: @distributor.age, company: @distributor.company, name: @distributor.name } }
    end
  ...
  test "should update distributor" do
    patch distributor_url(@distributor), params: { distributor: { age: @distributor.age, company: @distributor.company, name: @distributor.name } }
