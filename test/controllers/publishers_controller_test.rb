...
class PublishersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publisher" do
    assert_difference('Publisher.count') do
      post publishers_url, params: { publisher: { age: @publisher.age, name: @publisher.name, organization_name: @publisher.organization_name, place: @publisher.place } }
    end
  ...
  test "should update publisher" do
    patch publisher_url(@publisher), params: { publisher: { age: @publisher.age, name: @publisher.name, organization_name: @publisher.organization_name, place: @publisher.place } }
