...
class PoliticiansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create politician" do
    assert_difference('Politician.count') do
      post politicians_url, params: { politician: { age: @politician.age, name: @politician.name, party: @politician.party } }
    end
  ...
  test "should update politician" do
    patch politician_url(@politician), params: { politician: { age: @politician.age, name: @politician.name, party: @politician.party } }
