...
class VotersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post voters_url, params: { voter: { age: @voter.age, first_name: @voter.first_name, last_name: @voter.last_name, place: @voter.place } }
    end
  ...
  test "should update voter" do
    patch voter_url(@voter), params: { voter: { age: @voter.age, first_name: @voter.first_name, last_name: @voter.last_name, place: @voter.place } }
